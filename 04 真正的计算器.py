...
class MyWindow(QWidget, Ui_Form):
    ...
    def bind(self):
        ...
        self.pushButton_pow_2.clicked.connect(lambda: self.addNumber('**2'))
        self.pushButton_neg.clicked.connect(lambda: self.addNumber('*(-1)'))
        self.pushButton_clear.clicked.connect(self.clear)
        self.pushButton_backspace.clicked.connect(self.delNumber)
