...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(225, 401)
        Form.setMinimumSize(QSize(100, 150))
        ...
        self.pushButton_pow_2 = QPushButton(Form)
        self.pushButton_pow_2.setObjectName(u"pushButton_pow_2")

        self.horizontalLayout.addWidget(self.pushButton_pow_2)
        ...
        self.pushButton_neg = QPushButton(Form)
        self.pushButton_neg.setObjectName(u"pushButton_neg")

        self.horizontalLayout_5.addWidget(self.pushButton_neg)
        ...
        self.horizontalLayout_5.addWidget(self.pushButton_equal)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_pow_2.setText(QCoreApplication.translate("Form", u"x\u00b2", None))
        self.pushButton_clear.setText(QCoreApplication.translate("Form", u"CE", None))
        self.pushButton_backspace.setText(QCoreApplication.translate("Form", u"<-", None))
        ...
        self.pushButton_neg.setText(QCoreApplication.translate("Form", u"+/-", None))
